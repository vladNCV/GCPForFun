...
public class UnmarshallerTests {
  ...
  public void testUnmarshalToObject_Double() {
    ...
    // Verify
    Assert.assertEquals(3.14, bean.object);
  ...
  public void testUnmarshalToObject_Long() {
    ...
    // Verify
    Assert.assertEquals(42L, bean.object);
  ...
  public void testUnmarshalToObject_List() {
    ...
    Entity entity =
        Entity.newBuilder(key)
            .set(
                "object",
                Arrays.asList(DoubleValue.of(3.14), LongValue.of(42), StringValue.of("hello")))
            .set(
                "list",
                Arrays.asList(DoubleValue.of(3.14), LongValue.of(42), StringValue.of("hello")))
            .set(
    ...
    Unmarshaller unmarshaller = new Unmarshaller();
    TestBean bean = new TestBean();
    bean.linkedList = new LinkedList<>();
  ...
  public void testUnmarshalToObject_Map2() {
    ...
    Entity entity =
        Entity.newBuilder(key)
            .set(
                "object",
                Entity.newBuilder().set("k1", Entity.newBuilder().set("k2", "v2").build()).build())
            .set(
                "map",
                Entity.newBuilder().set("k1", Entity.newBuilder().set("k2", "v2").build()).build())
            .build();
  ...
  public void testUnmarshalToObject_Timestamp() {
    ...
    // Verify
    Assert.assertEquals(OffsetDateTime.parse("2017-07-09T12:34:56Z").toInstant(), bean.object);
    Assert.assertEquals(
        OffsetDateTime.parse("2017-07-09T12:34:56Z").toEpochSecond(), bean.primitiveLong);
    Assert.assertEquals(
        Long.valueOf(OffsetDateTime.parse("2017-07-09T12:34:56Z").toEpochSecond()), bean.boxedLong);
    Assert.assertEquals(
        Date.from(OffsetDateTime.parse("2017-07-09T12:34:56Z").toInstant()), bean.date);
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        OffsetDateTime.parse("2017-07-09T12:34:56Z")
            ...
            .toLocalDateTime(),
        bean.localDateTime);
    Assert.assertEquals(OffsetDateTime.parse("2017-07-09T12:34:56Z"), bean.offsetDateTime);
    Assert.assertEquals(ZonedDateTime.parse("2017-07-09T12:34:56Z"), bean.zonedDateTime);
  }
