...
public class GcloudDatastoreQueryCreatorTests {
  ...
  private GcloudDatastoreQueryCreator createCreator(
      Class<?> repositoryClass, Method method, Object... values) {
    ...
    return new GcloudDatastoreQueryCreator(
        new PartTree(
            method.getName(), queryMethod.getResultProcessor().getReturnedType().getDomainType()),
  ...
  public void testSingleCondition() throws Exception {
    // Setup
    GcloudDatastoreQueryCreator creator =
        createCreator(
  ...
  public void testAndCondition() throws Exception {
    ...
    GcloudDatastoreQueryCreator creator =
        createCreator(
            PersonRepository.class,
            PersonRepository.class.getMethod(
                "findByEmailAddressAndLastName", String.class, String.class),
        ...
        Query.newEntityQueryBuilder()
            .setFilter(
                StructuredQuery.CompositeFilter.and(
                    StructuredQuery.PropertyFilter.eq("emailAddress", "john.doe@example.com"),
