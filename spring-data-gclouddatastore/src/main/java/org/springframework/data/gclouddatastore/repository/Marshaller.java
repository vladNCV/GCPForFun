...
class Marshaller {
  ...
  private Value<?> toDatastoreValue(Object value) {
    if (value == null) {
      ...
      return TimestampValue.of(Timestamp.fromProto((com.google.protobuf.Timestamp) value));
    } else if (value instanceof Calendar) {
      String rfc3339 =
          OffsetDateTime.ofInstant(((Calendar) value).toInstant(), ZoneOffset.UTC).toString();
      return TimestampValue.of(Timestamp.parseTimestamp(rfc3339));
    } else if (value instanceof OffsetDateTime) {
      String rfc3339 = ((OffsetDateTime) value).withOffsetSameInstant(ZoneOffset.UTC).toString();
      return TimestampValue.of(Timestamp.parseTimestamp(rfc3339));
    } else if (value instanceof ZonedDateTime) {
      return TimestampValue.of(
          Timestamp.ofTimeSecondsAndNanos(
              ((ZonedDateTime) value).toEpochSecond(), ((ZonedDateTime) value).getNano()));
  ...
  FullEntity<? extends IncompleteKey> toEntity(Object object, Key key) {
  ...
  private void setEntityValue(
      FullEntity.Builder<? extends IncompleteKey> builder, String name, Object value) {
